...
define(function (require) {
    ...
    var _ = require('underscore'),
        ...
        Calendar = require('nbcourt/js/calendar-view'),
        EventCollection = require('nbcourt/js/calendar/event/collection'),
        ConnectionCollection = require('nbcourt/js/calendar/connection/collection');
